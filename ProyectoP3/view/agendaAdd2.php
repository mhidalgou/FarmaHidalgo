...
session_start();
include('header.php');
include('imaFarmHid.php'); 
include('cls_agenda2.php');
$invoice = new cls_agenda2();
$invoice->checkLoggedIn();
if(!empty($_POST['idclientegg']) && $_POST['idclientegg']) {	
	$invoice->saveInvoice($_POST);
	header("Location:agenda_lista.php");	
}
?>
			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 pull-right">
    				...
    				<div class="form-group">
        				...
        				<input class="form-control" id="fecha" name="fecha" placeholder="DD/MM/YYY" type="date" required="true" />
